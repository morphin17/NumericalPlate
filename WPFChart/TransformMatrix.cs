    ...
    public class TransformMatrix
    {
        ...
        public void OnMouseMove(Point pt, System.Windows.Controls.Viewport3D viewPort)
        {
            ...
            else
            {
                ...
                m_viewMatrix.Rotate(new Quaternion(new Vector3D(-1, 1, 0), aX));
                m_viewMatrix.Rotate(new Quaternion(new Vector3D(0, 0, 1), aY));
                m_movePoint = pt;
            }
        ...
        public void rotate()
        {
            m_viewMatrix.Rotate(new Quaternion(new Vector3D(0, 0, 1), 0.5));
            m_totalMatrix = Matrix3D.Multiply(m_projMatrix, m_viewMatrix);
        }
